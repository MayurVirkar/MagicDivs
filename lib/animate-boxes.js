...
$(document).ready(function () {
	...
	var box1_image = 'lib/my.jpg',
		...
		anim_height = 500,
		anim_width = 400,
		defaultWgt = 233, //by default, it will be of 300 width
	...
	{
		$('#box1, #box2, #box3, #box4, #box5, #box6, #box7').stop(true);
		$('#box1 div, #box2 div, #box3 div, #box4 div, #box5 div, #box6 div, #box7 div').stop(true);
	}
